 ...
 * @typedef {{ type: 'drums.preview', instrument: 'kick' | 'snare' | 'hihat' } | { type: 'drums.selectClip', bar: number } | { type: 'drums.toggle', bar: number, step: number, instrument: 'kick' | 'snare' | 'hihat', preview: boolean }} DrumsCommand
