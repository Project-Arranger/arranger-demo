...
test('chord pitch rail rows align with chord grid rows', async () => {
  ...
  assert.match(css, /\.cell\s*\{[^}]*background:\s*rgb\(255 248 232 \/ 0\.94\);/s);
  assert.doesNotMatch(css, /\.cell\s*\{[^}]*linear-gradient/s);
  assert.match(css, /\.note-key\s*\{[^}]*background:\s*rgb\(255 248 232 \/ 0\.94\);/s);
  assert.doesNotMatch(css, /\.note-key\s*\{[^}]*linear-gradient/s);
  assert.match(css, /\.cell\.sharp\s*\{[^}]*background:\s*rgb\(255 248 232 \/ 0\.94\);/s);
  assert.doesNotMatch(css, /\.cell\.sharp\s*\{[^}]*linear-gradient/s);
...
test('bass editor mirrors the reference piano-roll and groove picker layout', async () => {
  ...
  assert.match(css, /\.bass-cell\s*\{[^}]*background:\s*rgb\(255 248 232 \/ 0\.94\);/s);
  assert.doesNotMatch(css, /\.bass-cell\s*\{[^}]*linear-gradient/s);
