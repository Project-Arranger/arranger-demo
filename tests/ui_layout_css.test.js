...
test('tutorial task targets make allowed cells and bars obvious', async () => {
  ...
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*--tutorial-cell-surface:/s);
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*position:\s*relative;/s);
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*z-index:\s*var\(--tutorial-target-z\);/s);
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*background:\s*var\(--tutorial-cell-surface\);/s);
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*border-color:\s*var\(--tutorial-cell-border\);/s);
  assert.doesNotMatch(css, /\.tutorial-cell-completed\s*\{[^}]*animation:/s);
  assert.match(css, /\.tutorial-cell-completed\s*\{[^}]*opacity:\s*1;/s);
  assert.doesNotMatch(css, /\.tutorial-cell-completed::after/);
  assert.match(css, /\.drum-step\.active\.tutorial-cell-completed\s*\{[^}]*background:\s*var\(--tutorial-cell-surface\);/s);
  assert.match(css, /\.drum-step\.active\.tutorial-cell-completed\s*\{[^}]*border-color:\s*var\(--tutorial-cell-border\);/s);
  assert.match(css, /\.tutorial-cell-completed-blue\s*\{[^}]*--tutorial-cell-accent:\s*oklch\(70% 0\.17 252\);/s);
  assert.match(css, /\.tutorial-cell-completed-green\s*\{[^}]*--tutorial-cell-accent:\s*oklch\(72% 0\.16 150\);/s);
  assert.match(css, /\.tutorial-cell-completed-yellow\s*\{[^}]*--tutorial-cell-accent:\s*oklch\(84% 0\.18 88\);/s);
