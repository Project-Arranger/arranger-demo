...
test('tutorial task targets make allowed cells and bars obvious', async () => {
  ...
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*--tutorial-highlight-rest-shadow:[^}]*0 0 0 3px color-mix\(in oklab,\s*white 68%,\s*transparent\)[^}]*0 0 0 8px color-mix\(in oklab,\s*var\(--c-drums\) 30%,\s*transparent\)[^}]*0 0 24px color-mix\(in oklab,\s*var\(--c-drums\) 28%,\s*transparent\);/s);
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*--tutorial-highlight-peak-shadow:[^}]*0 0 0 4px color-mix\(in oklab,\s*white 82%,\s*transparent\)[^}]*0 0 0 11px color-mix\(in oklab,\s*var\(--c-drums\) 40%,\s*transparent\)[^}]*0 0 34px color-mix\(in oklab,\s*var\(--c-drums\) 38%,\s*transparent\);/s);
  ...
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*background:\s*color-mix\(in oklab,\s*var\(--c-drums\) 26%,\s*white\);/s);
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*border:\s*1px solid color-mix\(in oklab,\s*var\(--c-drums-ink\) 30%,\s*var\(--border-soft\)\);/s);
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*outline:\s*3px solid color-mix\(in oklab,\s*white 76%,\s*transparent\);/s);
  ...
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*filter:\s*brightness\(1\.18\) saturate\(1\.18\);/s);
  ...
  assert.match(css, /\.transport\.tutorial-transport-target \.t-btn\.play\.active\s*\{[^}]*background:\s*color-mix\(in oklab,\s*var\(--c-drums\) 26%,\s*white\);/s);
  ...
  assert.match(css, /@media\s*\(prefers-reduced-motion:\s*reduce\)\s*\{[\s\S]*\.transport\.tutorial-transport-target \.t-btn\.play\s*\{[^}]*animation:\s*none;[^}]*filter:\s*brightness\(1\.5\) saturate\(1\.38\);[^}]*box-shadow:\s*var\(--tutorial-highlight-peak-shadow\);/s);
